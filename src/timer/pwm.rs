...
use crate::pac::TIM5;
use crate::pac::{TIM1, TIM15, TIM16, TIM17, TIM2, TIM3, TIM4, TIM8};
...
macro_rules! tim_pin_hal {
    ...
    ($($TIMX:ident:
       ($CH:ty, $ccxe:ident, $ccxp:ident, $ccmrx_output:ident, $ocxpe:ident, $ocxm:ident,
        ...
        $(
            impl<COMP, POL, NPOL> PwmPin for Pwm<$TIMX, $CH, COMP, POL, NPOL>
...
macro_rules! lptim_hal {
    ($($TIMX:ident: $timX:ident,)+) => {
        $(
            ...
            impl PwmPin for Pwm<$TIMX, C1, ComplementaryImpossible, ActiveHigh, ActiveHigh> {
                type Duty = u16;
